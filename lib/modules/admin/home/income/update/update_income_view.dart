...
class UpdateIncomeView extends GetView<UpdateIncomeController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(name: "update_income".tr, isUrdu: controller.isUrdu),
      body: SafeArea(
        child: Stack(
                  ...
                  children: [
                    ...
                    Obx(
                      () => TextInputField(
                        ...
                        obscureText: false,
                        readOnly: false,
                        initialValue: controller.model.value.odometer
                            .toString(),
                    ...
                    CardTextInputField(
                      ...
                      onTap: () {
                        Get.toNamed(
                          ...
                          if (e != null) {
                            controller.incomeTypeController.text = e;
                          }
                        });
                      },
                      onSaved: (value) {},
