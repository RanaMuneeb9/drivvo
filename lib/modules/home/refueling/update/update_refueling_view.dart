  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => controller.updateRefueling(),
            icon: Text(
              "update".tr,
              style: Utils.getTextStyle(
                baseSize: 14,
          ...
          child: Column(
            ...
            children: [
              ...
              CardTextInputField(
                ...
                onTap: () {
                  Get.toNamed(
                    ...
                    if (e != null) controller.fuelController.text = e;
                  });
                },
                onSaved: (value) {},
                onValidate: (value) {
              ...
              TextInputFieldWithController(
                ...
                inputAction: TextInputAction.next,
                type: TextInputType.number,
                onChange: (value) => controller.onPriceChanged(value),
                onTap: () {},
                onSaved: (value) {},
                onValidate: (value) {
                  if (value == null || value.isEmpty) {
              ...
              TextInputFieldWithController(
                ...
                inputAction: TextInputAction.next,
                type: TextInputType.number,
                onChange: (value) => controller.onTotalCostChanged(value),
                onTap: () {},
                onSaved: (value) {},
                onValidate: (value) {
                  if (value == null || value.isEmpty) {
