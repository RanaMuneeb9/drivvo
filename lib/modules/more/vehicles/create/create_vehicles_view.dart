          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                onChanged: (String? value) => controller.onSelectTank(value!),
                validator: (value) {
                  if (value == null || value == "") {
              ...
              const SizedBox(height: 16),
              FormLabelText(title: "fuel_type".tr, isUrdu: controller.isUrdu),
              const SizedBox(height: 4),
              DropdownButtonFormField<String>(
                initialValue: null,
                icon: const Icon(Icons.keyboard_arrow_down),
                style: const TextStyle(color: Colors.black, fontSize: 16),
                items: controller.fuelTypesList.map<DropdownMenuItem<String>>((
                  element,
                ) {
                  return DropdownMenuItem<String>(
                    value: element,
                  ...
                  () => Row(
                    ...
                    children: [
                      ChoiceChip(
                        ...
                        selected:
                            controller.selectedChipName.value == "Kilometers",
                      ...
                      ChoiceChip(
                        label: Text(
                          ...
                          style: Utils.getTextStyle(
                            baseSize: 14,
                            isBold: false,
                            color: controller.selectedChipName.value == "Miles"
                                ? Colors.white
                                : Colors.black,
                            isUrdu: controller.isUrdu,
                          ),
                        ...
                        visualDensity: VisualDensity.compact,
                        selected: controller.selectedChipName.value == "Miles",
                        onSelected: (bool selected) {
                          if (selected) {
